...
<meta charset="utf-8">
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-B3F09ZML27"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-B3F09ZML27');
</script>
...
// time, which silently bumped "Last updated" on every autoblog rebuild. A legal page whose
// revision date moves on its own is worthless as a record of what it said and when.
// Change it BY HAND, and only when the text below actually changes.
function legalPage(slug, title, intro, sections, updated) {
  const body = pageHero({ eyebrow:"Legal", crumb: crumbNav(["Home","/"],[title]), h1:title, sub:intro, cta:false })
    + `<div class="page-body"><section class="section"><div class="wrap"><div class="prose reveal">
      <p style="color:var(--ink-soft)">Last updated: ${updated}</p>
      ${sections.map(s => `<h2>${s[0]}</h2>${s[1]}`).join('')}
      <h2>Contact</h2><p>Questions about this page? Reach me at <a href="mailto:${site.email}">${site.email}</a> or ${site.phone}.</p>
    </div></div></section></div>`;
...
function privacy() {
  return legalPage("privacy-policy", "Privacy Policy",
    ...
    [
      ...
      ["How I use it", "<ul><li>To respond to your inquiry and provide the services you ask about.</li><li>To contact you by phone, text message, and email about your request, including automated and AI-generated text messages, where you have consented to that. See the text messaging section below.</li><li>To schedule and confirm calls and meetings.</li><li>To follow up about your project and send relevant updates.</li><li>To deliver, bill for, and support the services you buy.</li><li>To improve this website and how I serve local businesses.</li><li>To meet legal, tax, and record-keeping obligations.</li></ul>"],

      ["Text messaging", "<p>This section governs mobile numbers and SMS. It is the part most people are actually looking for.</p><p><strong>How I get your consent.</strong> I send marketing and follow-up text messages only to people who gave me their mobile number and agreed to be texted, either by checking a consent box on one of my forms, by asking me to text them, or by texting me first.</p><p><strong>What I send.</strong> Messages about the services you asked about: a reply to your inquiry, a link to book a call, appointment confirmations and reminders, short qualifying questions before a scheduled call, and occasional follow-up. <strong>Some of these messages are sent automatically, and some are written by an AI assistant.</strong> You can always ask to speak with me directly.</p><p><strong>Frequency and cost.</strong> Message frequency varies, typically two to eight messages per month. Message and data rates may apply. Your mobile carrier is not liable for delayed or undelivered messages.</p><p><strong>How to stop.</strong> Reply <strong>STOP</strong> to any message and I will stop texting you. I also honor <strong>QUIT</strong>, <strong>END</strong>, <strong>CANCEL</strong>, <strong>UNSUBSCRIBE</strong>, <strong>REVOKE</strong>, and <strong>OPT OUT</strong>, and I honor plain-language requests such as \"stop texting me\" or \"take me off your list.\" You do not have to use a specific word. You can also opt out by replying to any email from me, by calling " + site.phone + ", or by emailing <a href=\"mailto:" + site.email + "\">" + site.email + "</a>. I will honor an opt-out request within ten business days, and in practice much faster. After you opt out you may receive one final message confirming it, which will contain no marketing.</p><p><strong>How to get help.</strong> Reply <strong>HELP</strong> to any message, or call " + site.phone + ".</p><p><strong>Consent is never required to buy anything.</strong> Agreeing to receive texts is not a condition of purchasing any service from me.</p><p><strong>The sharing rule, stated plainly.</strong> No mobile information will be shared with third parties or affiliates for marketing or promotional purposes. Information sharing to subcontractors in support services, such as customer service, is permitted. All other use case categories exclude text messaging originator opt-in data and consent; this information will not be shared with any third parties.</p>"],

      ["How I share it", "<p><strong>I do not sell your information, and I do not share it for anyone else's marketing.</strong></p><p>I share it only with the tools I use to run the business, and only as needed to serve you. Those currently include, among others: Salesmate (CRM, scheduling, phone, and text messaging), Google Workspace (email and calendar), Meta (advertising and lead forms), Google (advertising and analytics), Netlify (website hosting), Zapier (moving data between those tools), and Stripe (payments). Each of those providers handles data under its own terms.</p><p>I may disclose information if required by law, to respond to lawful requests, or to protect my rights, the rights of a client, or someone's safety.</p><p>If the business is ever sold or merged, customer information could transfer as part of that transaction. If that happens, this policy governs until you are told otherwise.</p>"],

      ["How long I keep it", "<p>I keep contact and business records for as long as you are a client and for a reasonable period afterward for tax, accounting, and legal reasons.</p><p><strong>Consent and opt-out records are kept for at least five years,</strong> because I have to be able to show whether and when someone agreed to be contacted, and whether and when they asked me to stop. Keeping an opt-out record is the only way to make sure an opt-out sticks.</p>"],

      ["Your choices and rights", "<p>You can ask me to see, correct, or delete the information I hold about you, and you can opt out of any kind of message at any time. Email <a href=\"mailto:" + site.email + "\">" + site.email + "</a> or call " + site.phone + " and I will handle it personally.</p><p>Depending on where you live, you may have additional rights under state privacy law, including the right to know what is collected, the right to delete, the right to correct, and the right to opt out of the sale or sharing of personal information. <strong>I do not sell or share personal information as those terms are used in those laws.</strong> I will honor a rights request from anyone who asks, regardless of whether a particular statute applies to a business my size.</p>"],

      ["Security", "<p>I use reputable, access-controlled services and limit who can see your information to myself and any subcontractor who needs it to do the work. No method of transmission or storage is completely secure, so I cannot guarantee absolute security, but I do not keep information I do not need.</p>"],

      ["Cookies & analytics", "<p>This site may use cookies and analytics to understand how visitors use it, and advertising pixels from Meta and Google to measure ad performance. You can disable cookies in your browser settings. Doing so will not stop you from using the site.</p>"],

      ["Children", "<p>This site and my services are for businesses and are not directed to anyone under 18. I do not knowingly collect information from children. If you believe a child has given me information, contact me and I will delete it.</p>"],

      ["Changes to this policy", "<p>I may update this policy as the business or the law changes. The revision date at the top reflects the last substantive change. Material changes to how I handle your mobile number or your consent will be posted here before they take effect.</p>"],
    ],
    "August 3, 2026");
}
function terms() {
  return legalPage("terms", "Terms of Service",
    ...
    [
      ...
      ["Acceptable use", "<p>Do not use this site or my messaging channels to send unlawful, abusive, or deceptive content, to attempt unauthorized access, to scrape or overload the site, or to impersonate anyone. I may stop responding to or block anyone who does.</p>"],

      ["Changes to these terms", "<p>I may update these terms as the business changes. The revision date at the top reflects the last substantive change. Continuing to use the site after a change means you accept the updated terms.</p>"],

      ["Governing law", "<p>These terms are governed by the laws of the State of Nebraska, without regard to its conflict of law rules. Any dispute arising from this website or these terms will be brought in the state or federal courts located in Douglas County, Nebraska. Nothing here waives any right you have under the consumer protection law of the state where you live.</p>"],
    ],
    "August 3, 2026");
}
